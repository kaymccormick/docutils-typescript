...
class Publisher {
    ...
    public setDestination(
        ...
        let outputEncodingErrorHandler = this.settings.docutilsCoreOptionParser.outputEncodingErrorHandler;// this.destination = new DestinationClass(//     {//         destination,//         destinationPath,//         encoding: outputEncoding,//         errorHandler: outputEncodingErrorHandler,//     },// );
    }
    ...
    public applyTransforms(): void {
        ...
        if (this.source === undefined || this.reader === undefined || this.reader.parser === undefined || this.writer === undefined || this.destination === undefined) {
    ...
    public publish(
        args: any,
        cb: (error: Error | undefined | {}, output: undefined | {}) => void
    ): void {
        const {
            /* eslint-disable-next-line @typescript-eslint/no-unused-vars,no-unused-vars */
            argv,
