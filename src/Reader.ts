...
export default class Reader extends Component {
    ...
    public getTransforms(): TransformType[] {
        return [...super.getTransforms(), universal.Decorations];// fixme//               universal.ExportInternals, universal.StripComments ];
    }
    ...
    public read(
        ...
        this.source.read(
            (error: Error | undefined | {}, output: string | {} | string[] | undefined): void => {
                if (error) {
                    cb(error, undefined);
                    return;
                }
    ...
    public parse(): void {
        ...
        }//this.document!.currentSource = '';//this.document!.currentLine = 0;
    }
