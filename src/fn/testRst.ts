...
* second item, with hyperlink target.`], ["Anonymous via .. no blankFinish", ".. __: http://www.python.org"], [
    "Nested sections",
    "Title\n=====\n\nSection-------\n\nThird@@@@@\n\nSecond\n======\n\nOoops\n@@@@@\n"
], ["Short overline", "===\nTitle\n===\n"], ["Short overline 2", "===\nTitle\n"], ["Incomplete title", "=====\nTitle\n", {
    expectError: true
}], [
    "Line block with continuation line",
...
- Bullets can be "*", "+", or "-".`], ["Bullet no unindent", "* bullet"], ["Nested bullets", "* bullet\n\n + bullet\n\n + bullet\n\n* bullet\n"], ["Transition correction", "====::\n"], ["Excerpt 1", `Configuration settings:
...
`
    ...
    "literal block without blank finish",
    `      Literal blocks are either indented or line-prefix-quoted blocks,
      and indicated with a double-colon ("::") at the end of the
      preceding paragraph (right here -->)::
...
`
    ...
    "substitution definition with image",
    ".. |symbol here| image:: symbol.png\n"
], ["incomplete substitution definition with image", ".. |beep"], ["definition list", `what
...
how
    ...
    the term.
`], [
    "definition list with classifier term",
    `term : classifier\n   test\n\nwhat
    Definition lists associate a term with a definition.
...
`
   ...
   indented by at least 3 spaces.`], ["Image Directive", ".. image:: mylogo.png\n"], ["Comment", `.. Comments begin with two dots and a space.  Anything may
   follow, except for the syntax of footnotes/citations,
   hyperlink targets, directives, or substitution definitions.`], ["Random", "* bullet\n* bullet\n\n "], ["Random 2", "Header 1\n========\nText\n\nHeader 2\n-------"], ["Random 2", "Test.\nTest2\nTest3\n-----"], ["Random 4", `Test3
-----

This is a test.

* BUllet list 1
* The emacs rst editor is weird.`], ["Emphasis", "*hello*"], ["Emphasis surrounded by text", "stuff *hello* things"], ["Emphasis preceded by text", "stuff *hello*"], ["Emphasis followed by text", "*hello* test"], ["Strong", "**hello**"], ["Emphasis and inline", "*hello* and **goodbye**"], ["Inline followed by emphasis", "**hello** and *goodbye*"], [
    "docutils title",
...
Another top-level paragraph.
    ...
    block quote.`], ["complex", `- This is the first line of a bullet list
...
`], ["tabs", "hello\ttabs\n"], [
    "footnote reference strangeness",
...
.. [*] This is the footnote.`], ["escaping 1", "*escape* ``with`` \"\\\""], ["escaping 2", "\\*escape* \\``with`` \"\\\\\""]];